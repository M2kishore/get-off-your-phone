    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (input.length() == 0) {
                    Toast.makeText(BreakTime.this, "Field can't be empty", Toast.LENGTH_SHORT).show();
                    return;
                }

                long millisInput = Long.parseLong(input) * 60000;
                if (millisInput == 0) {
                    Toast.makeText(BreakTime.this, "Please enter a positive number", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        mButtonReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                resetTimer();
                stopService(new Intent(BreakTime.this, FloatingWindow.class));
            }
     ...
     private void startTimer() {
         ...
         mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
             ...
             public void onFinish() {
                 ...
                 if (checkOverlayDisplayPermission()) {
                     // FloatingWindow service is started
                     startService(new Intent(BreakTime.this, FloatingWindow.class));
                     // The MainActivity closes here
                     finish();
                 } else {
                     // If permission is not given,
